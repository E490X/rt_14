...
import BotimLogs from "views/MessagesLogs/BotimLogs";
import WeChatLogs from "views/MessagesLogs/WeChatLogs";
import DiscreetAppLogs from "views/MessagesLogs/DiscreetAppLogs";
...
const privateRoutes = [
  ...
  { path: "/user/botim/:userDeviceId", component: BotimLogs },
  { path: "/user/wechat/:userDeviceId", component: WeChatLogs },
  { path: "/user/discreet-app/:userDeviceId", component: DiscreetAppLogs },
